        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-[800px]">
          ...
          >
            ...
            <div className="absolute bottom-0 p-12 w-full">
              <h3 className="font-display-lg text-on-surface mb-4">Hôtellerie de Luxe</h3>
              <p className="font-body-md text-on-surface-variant max-w-md mb-8">Optimisation des rendements opérationnels et ingénierie de l'expérience client pour les établissements de renommée mondiale.</p>
          ...
          >
            ...
            <div className="absolute bottom-0 p-12">
              <h3 className="font-headline-md text-on-surface mb-4">Haute Restauration</h3>
              <p className="text-on-surface-variant text-sm mb-6">Stratégies de croissance et structuration financière pour les groupes gastronomiques multi-étoilés.</p>
              <span className="material-symbols-outlined text-tertiary">arrow_right_alt</span>
            </div>
          </motion.div>
          {/* Retail de Prestige */}
          ...
          >
            ...
            <div className="absolute left-0 h-full flex flex-col justify-center p-12 max-w-xl">
              <h3 className="font-display-lg text-on-surface mb-2">Retail de Prestige</h3>
              <p className="font-body-md text-on-surface-variant">Positionnement global et transformation digitale des Maisons de luxe historiques.</p>
            </div>
          </motion.div>
        </div>
      </div>
